    ...
    <div id="pricing" className="bg-gray-100 py-12">
      <div className="w-[100%] mx-auto px-4 sm:px-12 lg:px-16 sm:w-[100%] flex flex-col items-center justify-center">
        ...
        <div className="gap-4 sm:gap-6 max-w-full flex flex-col lg:flex-row px-4 w-full">
          {/* Free Plan */}
          <div className="bg-gray-50 rounded-3xl p-4 sm:p-8 flex-1">
          ...
          {/* Pro Monthly Plan */}
          <div className="bg-gray-50 rounded-3xl p-6 sm:p-8 border-2 border-brand-secondary flex-1">
          ...
          {/* Pro Annual Plan */}
          <div className="bg-orange-50 rounded-3xl p-6 sm:p-8 border-2 border-highlight flex-1 relative">
            {/* Most Popular Badge */}
            <div className="absolute top-4 right-4 bg-highlight text-white text-xs font-bold px-3 py-1 rounded-full">
              Most Popular
            </div>
